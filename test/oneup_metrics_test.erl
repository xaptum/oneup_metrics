...
init_from_config_test() ->
  ...
  {oneup_counter, Ref1} = oneup_metrics:get_metric(StatsMap, [a, b, c1, d1, ref1]),
  {oneup_counter, Ref2} = oneup_metrics:get_metric(StatsMap, [a, b, c1, d2, ref2]),
  {oneup_counter, Ref3} = oneup_metrics:get_metric(StatsMap, [a, b, c2, d1, ref3]),
  {oneup_counter, Ref4} = oneup_metrics:get_metric(StatsMap, [a, b, c2, d1, ref4]),

  StatsA = oneup_metrics:get_metrics(StatsMap, [a]),
  StatsAExpected = #{b => #{c1 => #{d1 => #{ref1 => {oneup_counter, Ref1}},
    d2 => #{ref2 => {oneup_counter, Ref2}}},
    c2 => #{d1 => #{ref3 => {oneup_counter, Ref3},
      ref4 => {oneup_counter, Ref4} }}}},

  StatsA = StatsAExpected,

  StatsB = oneup_metrics:get_metrics(StatsMap, [a, b]),
  StatsBExpected = #{c1 => #{d1 => #{ref1 => {oneup_counter, Ref1}},
    d2 => #{ref2 => {oneup_counter, Ref2}}},
    c2 => #{d1 => #{ref3 => {oneup_counter, Ref3},
      ref4 => {oneup_counter, Ref4}}}},
  ...
  StatsC1Expected = #{d1 => #{ref1 => {oneup_counter, Ref1}}, d2 => #{ref2 => {oneup_counter, Ref2}}},
  StatsC1 = StatsC1Expected,

  StatsC2 = oneup_metrics:get_metrics(StatsMap, [a, b, c2]),
  StatsC2Expected = #{d1 => #{ref3 => {oneup_counter, Ref3}, ref4 => {oneup_counter, Ref4} }},
  StatsC2 = StatsC2Expected,

  StatsC1D1 = oneup_metrics:get_metrics(StatsMap, [a, b, c1, d1]),
  StatsC1D1Expected = #{ref1 => {oneup_counter, Ref1}},
  StatsC1D1 = StatsC1D1Expected,

  StatsC2D1 = oneup_metrics:get_metrics(StatsMap, [a, b, c2, d1]),
  StatsC2D1Expected = #{ref3 => {oneup_counter, Ref3}, ref4 => {oneup_counter, Ref4}},
  StatsC2D1 = StatsC2D1Expected,

  Ref3Expected = oneup_metrics:get_metric(StatsMap, [a, b, c2, d1, ref3]),
  {oneup_counter, Ref3} = Ref3Expected,

  {oneup_counter, Ref5} = oneup_metrics:get_metric(StatsMap, [a2, b2, c2, d2, ref5]),
  0 = oneup:get(Ref5),

  StatsA2 = oneup_metrics:get_metrics(StatsMap, [a2]),
  StatsA2Expected = #{b2 => #{c2 => #{d2 => #{ref5 => {oneup_counter, Ref5}}}}},
...
counter_test()->
  ...
  {oneup_counter, CounterRef1} = oneup_metrics:get_metric([a,b,c1,d1,ref1]),
